tell application "iTerm 2"
	...
	tell SI1terminal
		...
		tell SI1a
			...
			«event ITRMWrte» given «class iTxt»:"/usr/local/scripts/nstop.pl n4.dca2"
		end tell
		set SI1b to (make new «class Pssn» at the end of every «class Pssn»)
		tell SI1b
			set name to "lr1.dca2"
			«event ITRMExec» given «class Cmnd»:"ssh lr1.dca2.plx"
			«event ITRMWrte» given «class iTxt»:"/usr/local/scripts/nstop.pl n5.dca2"
		end tell
		set SI1c to (make new «class Pssn» at the end of every «class Pssn»)
		tell SI1c
			set name to "lr1.dca2"
			«event ITRMExec» given «class Cmnd»:"ssh lr1.dca2.plx"
			«event ITRMWrte» given «class iTxt»:"/usr/local/scripts/nstop.pl n6.dca2"
		end tell
		...
		tell SI1d
			...
			«event ITRMWrte» given «class iTxt»:"/usr/local/scripts/nstop.pl n4.sjc2"
		end tell
		set SI1e to (make new «class Pssn» at the end of every «class Pssn»)
		tell SI1e
			set name to "lr1.sjc2"
			«event ITRMExec» given «class Cmnd»:"ssh lr1.sjc2.plx"
			«event ITRMWrte» given «class iTxt»:"/usr/local/scripts/nstop.pl n5.sjc2"
		end tell
		set SI1f to (make new «class Pssn» at the end of every «class Pssn»)
		tell SI1f
			set name to "lr1.sjc2"
			«event ITRMExec» given «class Cmnd»:"ssh lr1.sjc2.plx"
			«event ITRMWrte» given «class iTxt»:"/usr/local/scripts/nstop.pl n6.sjc2"
		end tell
		...
		tell SI1g
			...
			«event ITRMWrte» given «class iTxt»:"/usr/local/scripts/nstop.pl n4.lon2"
		end tell
		set SI1h to (make new «class Pssn» at the end of every «class Pssn»)
		tell SI1h
			set name to "lr1.lon2"
			«event ITRMExec» given «class Cmnd»:"ssh lr1.lon2.plx"
			«event ITRMWrte» given «class iTxt»:"/usr/local/scripts/nstop.pl n5.lon2"
		end tell
		set SI1i to (make new «class Pssn» at the end of every «class Pssn»)
		tell SI1i
			set name to "lr1.lon2"
			«event ITRMExec» given «class Cmnd»:"ssh lr1.lon2.plx"
			«event ITRMWrte» given «class iTxt»:"/usr/local/scripts/nstop.pl n6.lon2"
		end tell
		...
		tell SI1g
			...
			«event ITRMWrte» given «class iTxt»:"/usr/local/scripts/nstop.pl n4.fra2"
		end tell
		set SI1h to (make new «class Pssn» at the end of every «class Pssn»)
		tell SI1h
			set name to "lr1.fra2"
			«event ITRMExec» given «class Cmnd»:"ssh lr1.fra2.plx"
			«event ITRMWrte» given «class iTxt»:"/usr/local/scripts/nstop.pl n5.fra2"
		end tell
		set SI1i to (make new «class Pssn» at the end of every «class Pssn»)
		tell SI1i
			set name to "lr1.fra2"
			«event ITRMExec» given «class Cmnd»:"ssh lr1.fra2.plx"
			«event ITRMWrte» given «class iTxt»:"/usr/local/scripts/nstop.pl n6.fra2"
		end tell
		...
		tell SI1j
			...
			«event ITRMWrte» given «class iTxt»:"/usr/local/scripts/nstop.pl n4.hkg2"
		end tell
		set SI1k to (make new «class Pssn» at the end of every «class Pssn»)
		tell SI1k
			set name to "lr1.hkg2"
			«event ITRMExec» given «class Cmnd»:"ssh lr1.hkg2.plx"
			«event ITRMWrte» given «class iTxt»:"/usr/local/scripts/nstop.pl n5.hkg2"
		end tell
		set SI1l to (make new «class Pssn» at the end of every «class Pssn»)
		tell SI1l
			set name to "lr1.hkg2"
			«event ITRMExec» given «class Cmnd»:"ssh lr1.hkg2.plx"
			«event ITRMWrte» given «class iTxt»:"/usr/local/scripts/nstop.pl n6.hkg2"
		end tell
		...
		tell SI1j
			...
			«event ITRMWrte» given «class iTxt»:"/usr/local/scripts/nstop.pl n4.tyo2"
		end tell
		set SI1k to (make new «class Pssn» at the end of every «class Pssn»)
		tell SI1k
			set name to "lr1.tyo2"
			«event ITRMExec» given «class Cmnd»:"ssh lr1.tyo2.plx"
			«event ITRMWrte» given «class iTxt»:"/usr/local/scripts/nstop.pl n5.tyo2"
		end tell
		set SI1l to (make new «class Pssn» at the end of every «class Pssn»)
		tell SI1l
			set name to "lr1.tyo2"
			«event ITRMExec» given «class Cmnd»:"ssh lr1.tyo2.plx"
			«event ITRMWrte» given «class iTxt»:"/usr/local/scripts/nstop.pl n6.tyo2"
		end tell
